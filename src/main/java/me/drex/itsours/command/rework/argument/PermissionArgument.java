...
public class PermissionArgument {
    ...
    public static PermissionInterface getPermission(CommandContext<ServerCommandSource> ctx, String name) throws CommandSyntaxException {
        String string = StringArgumentType.getString(ctx, name);
        try {
            return PermissionRework.of(string);
