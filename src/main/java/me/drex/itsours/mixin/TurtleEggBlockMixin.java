...
public abstract class TurtleEggBlockMixin {
    ...
    public boolean itsours$canPlayerBreakEgg(boolean original, World world, BlockState state, BlockPos pos, Entity entity) {
        ...
        if (claim.isPresent() && entity instanceof PlayerEntity player && !claim.get().hasPermission(entity.getUuid(), PermissionManager.MINE, Node.dummy(Registries.BLOCK, (TurtleEggBlock) (Object) this))) {
